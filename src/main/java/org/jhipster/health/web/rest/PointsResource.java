...
import org.jhipster.health.repository.repositoryImpl.PointsRepositoryImpl;
...
public class PointsResource {
    ...
    private final PointsRepositoryImpl pointsRepositoryImpl;

    public PointsResource(PointsRepository pointsRepository, PointsSearchRepository pointsSearchRepository, UserRepository userRepository, PointsRepositoryImpl pointsRepositoryImpl) {
        this.pointsRepository = pointsRepository;
        this.pointsSearchRepository = pointsSearchRepository;
        this.userRepository = userRepository;
        this.pointsRepositoryImpl = pointsRepositoryImpl;
    }
...
//        Points result = pointsRepository.save(points);
        pointsRepositoryImpl.updatePoints(points);
